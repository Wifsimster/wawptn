...
export function AppFooter() {
  ...
  return (
    <footer className="border-t border-white/[0.04] px-4 py-6 mt-auto">
      <div className="max-w-5xl mx-auto flex items-center justify-center gap-2.5 text-xs text-muted-foreground/25">
        <WawptnLogo size={16} className="text-muted-foreground/25" />
        <span>
